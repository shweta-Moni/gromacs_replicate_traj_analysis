...
Step 7: extract_pdb.sh 
=======================
This script extracts PDB snapshots at 100 ns intervals from GROMACS trajectory files for 5 replicates and saves them in a structured snapshot/replicate{1..5} directory.
